...
def create_dataset_and_evalmetrix(args, mode='pretrain'):
    ...
    for single_client in args.dis_cvs_files:
            ...
            datalist_json = os.path.join(args.data_path, f'{args.n_clients}_clients', args.split_type, single_client)
            ...
            args.clients_with_len[single_client] = len(datalist)

            print(f"args.clients_with_len[{single_client}]",train_ds)
