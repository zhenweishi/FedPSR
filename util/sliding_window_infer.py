...
def sliding_window_inference(
    ...
    **kwargs: Any,
    ...
    for slice_g in tqdm(windows_range) if progress else windows_range:
        ...
        # print("seg_prob_out_1:", type(seg_prob_out))
        # print("seg_prob_out_1:", seg_prob_out.size())
        seg_prob_out = seg_prob_out['out']
        # print("seg_prob_out_2:", type(seg_prob_out))
        # print("seg_prob_out_2:", seg_prob_out.size())
